...
const IMAGES = [
  { src: "/images/pillars/my-animals.jpeg", alt: "Animal care at the RKM shelter" },
...
function StoryText() {
  return (
    <>
      ...
      <h2 className="h-display mt-4 text-3xl sm:text-4xl lg:text-5xl">It started with our dog, Tobler.</h2>
      <p data-story="para" className="mt-5 leading-relaxed text-ink/70">
        When Tobler fell ill, we spent a few long nights at the vet clinic. What stayed with us
        wasn&apos;t our own worry — it was the people who kept coming through the door. Strangers,
        mostly. They&apos;d found a dog or a cat hurt on the road, carried it in, and then learned
        the treatment cost more than they had.
      </p>
      <blockquote data-story="quote" className="mt-6 border-l-2 border-copper pl-5 text-lg font-medium leading-relaxed text-ink/90">
      ...
      <p data-story="attr" className="mt-4 text-sm font-medium text-ink/60">— The Mundhra family</p>
...
/** Static fallback — identical to the production homepage Story section. */
      ...
      <div className="container-c grid items-center gap-12 lg:grid-cols-2">
        <Reveal className="order-2 lg:order-1">
          <div className="img-hover aspect-[4/5]">
            <img src={IMAGES[0].src} alt={IMAGES[0].alt} className="object-cover" loading="lazy" />
          </div>
        </Reveal>
