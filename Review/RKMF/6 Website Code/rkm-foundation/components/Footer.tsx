  ...
  return (
    <footer className="border-t border-ink/10 bg-snow">
      <div className="container-c py-12">
        <SubscribeForm />
        <div className="mt-12 grid gap-10 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_auto]">
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-ink/70">
              ...
              <li>
                <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-copper-dark">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" aria-hidden><path d="M21 12a9 9 0 0 1-13.4 7.8L3 21l1.3-4.4A9 9 0 1 1 21 12Z"/></svg>
                  {SITE.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${SITE.email}`} className="inline-flex items-center gap-2 hover:text-copper-dark">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" aria-hidden><rect x="2" y="4" width="20" height="16" rx="3"/><path d="m3 6 9 7 9-7"/></svg>
                  {SITE.email}
                </a>
              </li>
              <li>
          ...
          <div className="hidden lg:block">
            ...
            <Link href="/donate-now" className="mt-4 block">
              <img src="/images/site/qr.png" alt="QR code to donate to RKM Foundation" width={140} height={140} loading="lazy" className="rounded-xl ring-1 ring-ink/10" />
            </Link>
