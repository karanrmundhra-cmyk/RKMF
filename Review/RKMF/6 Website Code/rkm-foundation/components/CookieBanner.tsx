...
export default function CookieBanner() {
  ...
  if (!show) return null;
  return (
    <div className="fixed bottom-4 left-4 z-50 flex max-w-[330px] flex-col gap-2.5 rounded-2xl bg-ink p-4 text-white shadow-2xl" role="dialog" aria-label="Cookie notice">
