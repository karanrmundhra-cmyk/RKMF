...
function H2({ children }: { children: React.ReactNode }) {
  return <h2 className="h-display mt-14 text-2xl sm:text-3xl">{children}</h2>;
}

function P({ children }: { children: React.ReactNode }) {
  return <p className="mt-5 leading-relaxed text-ink/75">{children}</p>;
}
      ...
      <section className="bg-snow pb-14 pt-32 sm:pt-40">
        <div className="container-c max-w-2xl">
          <Reveal>
            ...
            <h1 className="h-display mt-4 text-4xl leading-tight sm:text-5xl">
        ...
        <div className="container-c max-w-2xl">
          ...
          <Reveal delay={100}>
            <figure className="mt-10">
              <div className="grid aspect-[4/3] place-items-center rounded-2xl bg-gradient-to-br from-copper/25 via-copper/10 to-copper/30 ring-1 ring-copper/20">
                <div className="text-center">
                  <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="mx-auto text-copper-dark/60" aria-hidden>
                    <rect x="3" y="5" width="18" height="14" rx="2" />
                    <circle cx="9" cy="10" r="1.6" />
                    <path d="m5 17 4.5-4.5 3 3L16 12l3 3" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <p className="mt-2 text-xs font-medium uppercase tracking-widest text-copper-dark/70">Photo coming soon</p>
                </div>
              </div>
              <figcaption className="mt-3 text-center text-sm italic text-ink/55">
                Tobler — the little pug whose love inspired the journey that became RKM Foundation.
              </figcaption>
            </figure>
          </Reveal>
          ...
          {/* Impact + CTA */}
          <Reveal delay={100}>
            <div className="mt-16 rounded-2xl bg-snow p-8 text-center ring-1 ring-ink/5 sm:p-10">
              <p className="mx-auto max-w-md text-lg font-medium leading-relaxed text-ink">
                Every contribution — no matter the size — helps turn compassion into real action
                for those who need it most.
              </p>
              <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
                <Link href="/donate-now" className="btn-copper">Donate Now</Link>
