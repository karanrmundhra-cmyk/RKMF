    ...
    <>
      <section className="bg-snow pb-14 pt-32 sm:pt-40">
        <div className="container-c max-w-3xl">
          ...
          <h1 className="h-display mt-4 text-4xl">80G / Tax Benefit Disclaimer</h1>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="container-c max-w-3xl prose-rkm">
          ...
          <h2 className="h-display mt-10 text-2xl">1. Voluntary Contributions</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">2. Use of Funds</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">3. No Financial or Investment Return</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">4. No Guarantee of Specific Outcomes</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">5. Compliance &amp; Eligibility</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">6. Tax Treatment</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">7. Refunds</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
