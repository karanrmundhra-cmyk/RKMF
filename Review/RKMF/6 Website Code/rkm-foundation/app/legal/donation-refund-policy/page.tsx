    ...
    <>
      <section className="bg-snow pb-14 pt-32 sm:pt-40">
        <div className="container-c max-w-3xl">
          ...
          <h1 className="h-display mt-4 text-4xl">Refund &amp; Cancellation Policy – Donations</h1>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="container-c max-w-3xl prose-rkm">
          ...
          <h2 className="h-display mt-10 text-2xl">1. Nature of Donations</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">2. Non-Refundable Donations</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">3. Limited Exceptions (Technical Errors Only)</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">4. 80G Tax Benefits &amp; Refunds</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">5. Donation Amount &amp; Payment Methods</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">6. Donation Receipts &amp; Certificates</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">7. Chargebacks &amp; Disputes</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
          ...
          <h2 className="h-display mt-10 text-2xl">8. Changes to This Policy</h2>
          <p className="mt-4 leading-relaxed text-ink/70">
