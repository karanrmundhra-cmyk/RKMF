...
export default function FAQsPage() {
  return (
    <>
      <section className="bg-snow pb-14 pt-32 sm:pt-40">
        <div className="container-c max-w-3xl">
          <Reveal>
            ...
            <h1 className="h-display mt-4 text-4xl sm:text-5xl lg:text-6xl">Frequently asked questions.</h1>
      ...
      {SECTIONS.map((s, i) => (
        <section key={s.eyebrow} className={`${i % 2 === 0 ? "bg-white" : "bg-copper/[0.03]"} py-24`}>
          <div className="container-c max-w-3xl">
            <Reveal>
              <p className="eyebrow">{s.eyebrow}</p>
              <h2 className="h-display mt-4 text-3xl sm:text-4xl">{s.title}</h2>
            </Reveal>
        ...
        <div className="container-c max-w-3xl">
          <Reveal>
            <div className="card p-7 sm:p-8">
              <h2 className="h-display text-2xl">Still have a question?</h2>
              ...
              <p className="mt-4 text-xs text-ink/60">{SITE.hours}</p>
            </div>
          </Reveal>
        </div>
      </section>
