      ...
      <section className="bg-snow pb-14 pt-32 sm:pt-40">
        <div className="container-c max-w-2xl text-center">
          <Reveal>
            ...
            <h1 className="h-display mt-4 text-4xl sm:text-5xl lg:text-6xl">Create Your Fundraiser</h1>
            <p className="mt-5 leading-relaxed text-ink/70">
              Start a fundraiser to help rescued animals receive food, medical care, and safe
              shelter. All donations raised through your fundraiser go directly to RKM Foundation.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container-c max-w-2xl">
          <Reveal>
            <FormShell
              ...
              note="To ensure responsible communication, our team reviews each fundraiser before it goes live. Fundraiser pages use approved photographs from the RKM Foundation shelter gallery."
            />
          </Reveal>
          ...
          <Reveal delay={120}>
            <div className="card mt-10 p-6 sm:p-8">
              <h2 className="text-lg font-semibold">How your fundraiser helps</h2>
              <p className="mt-2 text-sm leading-relaxed text-ink/70">
                Every contribution helps provide care, treatment, and protection for rescued
                animals. Examples of how funds may support animals in our care:
              </p>
              <ul className="mt-4 space-y-3">
                {TIERS.map((t) => (
                  <li key={t.amount} className="flex items-baseline gap-3 text-sm">
                    <span className="shrink-0 font-semibold text-copper-dark">{t.amount}</span>
                    <span className="text-ink/70">— {t.desc}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <Reveal delay={160}>
            <div className="mt-10">
              ...
              <ul className="mt-3 space-y-2 text-sm leading-relaxed text-ink/70">
                <li>• You will receive a unique fundraiser page to share with friends and family</li>
                <li>• Donations will go directly to RKM Foundation</li>
                <li>• Donors will receive instant receipts and tax benefits where applicable</li>
                <li>• You will be able to track the progress of your fundraiser</li>
              </ul>
            </div>
          </Reveal>
        </div>
