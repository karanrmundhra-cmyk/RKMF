...
const PLACEHOLDERS = [
  "A real supporter's words about why they give will live here.",
  "This card will hold an authentic story from someone in our community.",
  "Genuine supporter voices will replace this copy.",
];
